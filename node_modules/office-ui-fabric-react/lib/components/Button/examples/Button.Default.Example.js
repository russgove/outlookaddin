    ...
    ButtonDefaultExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'ms-BasicButtonsExample' },
            React.createElement("div", null,
                React.createElement(Button_1.DefaultButton, { "data-automation-id": 'test', disabled: disabled, toggled: toggled, iconProps: { iconName: 'Add' }, description: 'I am a description', text: 'Create account' }))));
    };
