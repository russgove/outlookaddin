...
define(["require", "exports", "react", "react-dom", "office-ui-fabric-react/lib/Utilities", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/Label"], function (require, exports, React, ReactDOM, Utilities_1, Button_1, Label_1) {
    ...
    var ButtonSwapExample = (function (_super) {
        ...
        ButtonSwapExample.prototype.render = function () {
            ...
            var _a = this.props, disabled = _a.disabled, toggled = _a.toggled;
            var text = 'Swap';
            // determine which button to render
            var button = isPrimary
                ? React.createElement(Button_1.PrimaryButton, { ref: this._setButtonRef, disabled: disabled, toggled: toggled, onClick: this._onClick }, text)
                : React.createElement(Button_1.DefaultButton, { ref: this._setButtonRef, disabled: disabled, toggled: toggled, onClick: this._onClick }, text);
