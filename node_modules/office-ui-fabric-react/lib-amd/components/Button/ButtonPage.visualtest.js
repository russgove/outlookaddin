    ...
    var ButtonVPage = (function (_super) {
        ...
        ButtonVPage.prototype.render = function () {
            ...
            return React.createElement("div", null,
                ...
                "\u00A0",
                React.createElement("div", null,
                    React.createElement("label", null, " Default Button Toggled:   "),
                    React.createElement(index_1.DefaultButton, { id: 'DefaultButtonToggled', icon: 'Add', toggled: true, text: 'Default Button' })),
                "\u00A0",
                ...
                "\u00A0",
                React.createElement("div", { style: { backgroundColor: 'white' } },
                    React.createElement(index_1.IconButton, { id: 'IconButtonToggled', toggled: true, iconProps: { iconName: iconName } })),
                "\u00A0",
                React.createElement("div", { style: { backgroundColor: 'white' } },
                ...
                "\u00A0",
                React.createElement("div", { style: { backgroundColor: 'white' } },
                    React.createElement(index_1.CommandButton, { id: 'CommandButtonToggled', toggled: true, icon: 'AddFriend', text: 'Command Button' })),
                "\u00A0",
                React.createElement("div", null,
                ...
                "\u00A0",
                React.createElement("div", null,
                    React.createElement(index_1.CompoundButton, { id: 'CompoundButtonToggled', toggled: true, description: 'You can create a new account here.', text: 'Compound Button' })),
                "\u00A0",
                React.createElement("div", null,
                ...
                "\u00A0",
                React.createElement("div", null,
                    React.createElement(index_1.PrimaryButton, { id: 'PrimaryButtonToggled', toggled: true, icon: 'Add', text: 'Primary Button' })),
                "\u00A0",
                React.createElement("div", null,
                    ...
                    React.createElement(index_1.DefaultButton, { id: 'ContextualButtonToggled', toggled: true, icon: 'Add', text: 'New', menuProps: {
                            className: 'ContextualButtonMenu',
                            id: 'ContextualButtonMenu',
                            items: [
                                {
